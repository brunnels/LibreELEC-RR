...
case "$LINUX" in
  ...
  rockchip-4.4)
    ...
    ;;
  raspberrypi)
    PKG_VERSION="aa4c02b03ba8ff81064f6f25192aaff979ebb039" # 5.3.7
    PKG_SHA256="a1e2f58ae469e6ab4ccd3b2f495899c621d63da08182f3ea008b787cc3e43b52"
    PKG_URL="https://github.com/raspberrypi/linux/archive/$PKG_VERSION.tar.gz"
    PKG_SOURCE_NAME="linux-$LINUX-$PKG_VERSION.tar.gz"
    ;;
  *)
    PKG_VERSION="5.3.7"
    PKG_SHA256="c6c9714e21531c825c306b107bc6f6c7bfa2d5270a14bad170f8de5a73d34802"
...
if [ "$PKG_BUILD_PERF" != "no" ] && grep -q ^CONFIG_PERF_EVENTS= $PKG_KERNEL_CFG_FILE ; then
  PKG_BUILD_PERF="yes"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET zlib binutils elfutils libunwind openssl"
fi
